          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/5 border border-brand-accent-gold/15 flex items-center justify-center text-brand-accent-gold hover:text-white hover:bg-[#25D366] hover:border-[#25D366] hover:scale-105 transition-all duration-300"
                aria-label="WhatsApp"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
